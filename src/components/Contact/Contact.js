...
const Contact = () => {
    ...
    const scrollFunctionalities =  ()=>{
        ...
        var contactMePos = (contactMeElem.current.getBoundingClientRect().top)-windowHeight+150;
        var emailPos = (emailElem.current.getBoundingClientRect().top)-windowHeight+50+x;
        var emailSVGPos = (emailSVGElem.current.getBoundingClientRect().top)-windowHeight+x;
        ...
        <div className="outer-grid" >
            ...
            <div className="body" >
                ...
                <div className="contactMe">
                    ...
                    <div className={(contactMeLoadChange?"contactMeContentAppear ":"")+"contactMeContent"}>
                        <h2>Contact Me</h2>
                        <p>I am available on almost every social media. You can message Me. 
                            I can help you with Full Stack Web Development.
                        </p>
                        <a href="https://drive.google.com/file/d/1ZIULVSXbBDQDL2VWPy6NuOCmGq6vawUr/view?usp=sharing" target="_blank" rel="noreferrer">
                ...
                <div className="emailMe">
                    <div className={(emailLoadChange?"emailMeContentAppear ":"")+"emailMeContent"}>
                        <h2>Email</h2>
                        <h5>rajpurohityogesh50@gmail.com</h5>
                        <a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSHwQhSMVxztKgVTHwnDjqrNcCCqqNMNFfFbKrxdmpzScnrkGrHLmBPjQdHmfQWWxzsVJSGc" target="_blank" rel="noreferrer">
                            <div className="button">
                                <span>Email Me</span>
                            </div>
                        </a>
                    </div> 
                    <img className={(emailSVGLoadChange?"emailSVGAppear ":"")+"emailSVG"} src={emailAvatar} alt="Email Avatar" />               
                </div>
